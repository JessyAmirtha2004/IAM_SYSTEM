...
class Code(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='codes')  # Add related_name to avoid conflicts
    number = models.CharField(max_length=10)  # Code length as per your requirement
    created_at = models.DateTimeField(auto_now_add=True)

    class Meta:
        db_table = 'code'  # Optional: define a table name for the Code model
